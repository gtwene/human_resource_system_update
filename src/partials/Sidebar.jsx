...
import Employees from './SubSideBarItems/Employees';
    ...
    <div>
      ...
      >
        ...
        <div className="flex justify-between mb-10 pr-3 sm:px-2">
          ...
          {/* Logo */}
          <NavLink className="">
            <img src='https://unionsg.com/images/logo.png' width="200" />
          </NavLink>
        </div>
                      ...
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center">
                            <svg className="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                              <path
                                className={`fill-current text-slate-400 ${pathname.includes('employees') && 'text-indigo-300'}`}
                                d="M13 15l11-7L11.504.136a1 1 0 00-1.019.007L0 7l13 8z"
                              />
                              <path
                                className={`fill-current text-slate-700 ${pathname.includes('employees') && '!text-indigo-600'}`}
                                d="M13 15L0 7v9c0 .355.189.685.496.864L13 24v-9z"
                              />
                              <path
                                className={`fill-current text-slate-600 ${pathname.includes('employees') && 'text-indigo-500'}`}
              ...
              <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${pathname.includes('inbox') && 'bg-slate-900'}`}>
                ...
                >
                  <div className="flex items-center">
                    ...
                    <span className="text-sm font-medium ml-3 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Personal Information</span>
                  </div>
                </NavLink>
              </li>
              {/* Calendar */}
                    ...
                    <React.Fragment>
                      ...
                      <div className="lg:hidden lg:sidebar-expanded:block 2xl:block">
                        ...
                        <li className="mb-1 last:mb-0">
                          ...
                          <li className="mb-1 last:mb-0">
                            <NavLink onClick={handleLogout} className="block text-slate-400 hover:text-slate-200 transition duration-150 truncate">
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                                Sign Out
                              </span>
                            </NavLink>
